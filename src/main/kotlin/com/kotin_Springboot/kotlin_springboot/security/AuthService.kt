...
import com.kotin_Springboot.kotlin_springboot.database.repository.RefreshTokenRepository
import com.kotin_Springboot.kotlin_springboot.database.repository.UserRepository
...
class AuthService(
    ...
    fun login(email:String, password: String):TokenPair{
        ...
        val newResfreshToken= jwtService.generateRefreshToken(user.id.toHexString())

        storeRefreshToken(user.id, newResfreshToken)
